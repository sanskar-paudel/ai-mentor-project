...
Pulls relevant context (RAG + recent chat history),
Decides whether diagnostic or planning would be helpful,
Always streams a Mentor answer first, and
Appends optional insights/widgets afterward.
